...
function tracker = LK_initialize_oop(tracker, frame_id, target_id, dres, ind, dres_image)
...
for i = 1:num
    ...
    I = dres_image.getFrameGray(tracker.frame_ids(i));
...
img = dres_image.getFrameGray(frame_id);
